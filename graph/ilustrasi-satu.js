document.addEventListener('DOMContentLoaded', function() {
    ...
    // 1. Membangun 250 titik-titik secara otomatis
    ...
    function updateZoom() {
        ...
        if (visibleDots > 250) visibleDots = 250;

        zoomSlider.value = visibleDots;

        // Hitung lebar track agar responsif menyesuaikan lebar jendela (viewport) saat ini
        const viewportWidth = viewport.clientWidth;
        const trackWidth = (totalDots / visibleDots) * viewportWidth;
